...
const StudentDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black relative overflow-hidden">
      ...
      {/* Main Content */}
      <div className="relative max-w-4xl mx-auto p-6 sm:p-8 flex flex-col items-center min-h-screen justify-center">
        <motion.div
        ...
        {/* Buttons */}
        <motion.button
          className="relative w-full max-w-md px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-full text-lg sm:text-xl font-semibold transform hover:scale-105 transition-all duration-300 overflow-hidden group mb-4"
        ...
        >
          ...
          <span className="relative z-10">Book Classes</span>
          <motion.span
        ...
        <motion.button
          className="relative w-full max-w-md px-8 py-4 bg-gradient-to-r from-red-500 to-red-700 text-white rounded-full text-lg sm:text-xl font-semibold transform hover:scale-105 transition-all duration-300 overflow-hidden group"
